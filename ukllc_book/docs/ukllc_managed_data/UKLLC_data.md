...
## Introduction
UK LLC-managed datasets fall into two groupings as detailed in the table below:
* Those created by the **UK LLC Data Team**
* Those created by **researchers** working in the TRE who make their derived datasets available for other researchers to use.
...
|Datasets|Grouping|Summary|Type of Data|Data Available in TRE|Data Owner|
|---|---|---|---|---|---|
