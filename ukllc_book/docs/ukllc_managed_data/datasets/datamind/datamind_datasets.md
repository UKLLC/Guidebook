...
Anonymised data from NHS England were used to identify the earliest diagnosis dates. The datasets considered were: 
 1. [**Mental Health Services Data Set (MHSDS)**.](../../../linked_health_data/nhs_england/mental_health_datasets/mhsds/mhsds.ipynb)
 2. [**Hospital Episode Statistics – Outpatients (HES OP)**.](../../../linked_health_data/nhs_england/hes_datasets/op/hesop.ipynb)
 3. [**Hospital Episode Statistics – Admitted Patient Care (HES APC)**.](../../../linked_health_data/nhs_england/hes_datasets/apc/hesapc.ipynb)
 4. [**Talking Therapies for Anxiety and Depression (IAPT)**.](../../../linked_health_data/nhs_england/mental_health_datasets/iapt/iapt.ipynb)
