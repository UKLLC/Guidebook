...
## Types of amendments
Amendments to projects fall into the following **five** categories (average time it takes for UK LLC to process each amendment type is included in parentheses):
* [**Request new data**](#request-new-data) (7.3 days)
* [**Add or remove a researcher**](#add-or-remove-a-researcher) (3.7 days to add; 7.2 days to remove)
* [**Move organisation**](#move-organisation) (2.0 days)
* [**Extend TRE access period**](#extend-tre-access-period) (1.1 days)
* [**Change research question**](#change-research-question) (12.5 days)
...
> **Note**  
> If your time in the TRE is extended, your data will **not be updated** to reflect changes in participants' consent status since the project was originally provisioned. Projects remain tied to their original [**'freeze'**](../../docs/ukllc_key_facts/Sample/UKLLC_sample.md).
