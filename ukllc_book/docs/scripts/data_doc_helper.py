...
class DocHelper:
    ...
    def connect(self):
        ...
        try:
            ...
            cnxn = sqlalchemy.create_engine('postgresql+psycopg2://ua5ho9fnckf5in:p0b75b8cebbdb9313517f7b6a9e760603908ddddf724594d532df49a4834ced03@cav8p52l9arddb.cluster-czz5s0kz4scl.eu-west-1.rds.amazonaws.com:5432/***REMOVED***')
            return(cnxn)
