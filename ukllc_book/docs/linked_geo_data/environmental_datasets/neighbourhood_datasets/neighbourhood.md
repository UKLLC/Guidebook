...
While there is no single generalisable definition of a 'neighbourhood', Suttles (1972) has suggested that neighbourhoods exist at three
different scales, each having its own predominant purpose or function (Table 1). Suttles' (1972) work can be used to suggest that a neighbourhood extends from 
