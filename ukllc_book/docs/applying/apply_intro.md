...
<div style="background-color: rgba(0, 178, 169, 0.3); padding: 5px; border-radius: 5px;"><strong>UK LLC welcomes applications from eligible researchers.</strong></div>
<br>


To ensure the appropriate and fair use of LPS participants’ information, UK LLC operates a rigorous **multi-stage application review process**. All applicants and their applications are assessed against the [**Five Safes Framework**](https://ukdataservice.ac.uk/help/secure-lab/what-is-the-five-safes-framework/) to determine if the application meets the requirements and commitments agreed with participants of the partner LPS and linked data owners.  

<aside class="admonition note"><p class="admonition-title">All projects <b>must</b> include data from at least one of UK LLC's partner LPS.</p>UK LLC does not enable access to linked data (e.g. electronic health records) alone.</a></aside>  
...
<img src="../images/application_process_diagram.png" width="1800"/>
